...
class Snake:
    ...
    def __init__(self, snake_body, snake_dir):
...
class Game:
    ...
    def next_move(self, snake, apple):
        ...
        if randint(0, 3) == 0:
            ...
            return self.get_direction(snake, apple)
    ...
    def play(self, window):
        try:
            ...
            while key != 27 and game_over == False:
                ...
                self.move(apple, move_apple, "*", window)
                if snake[0] == apple[0]:
                    apple = []
                    score += 1
                    while apple == []:
